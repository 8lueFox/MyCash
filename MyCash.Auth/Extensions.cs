...
using MyCash.Auth.JWT;
using System.Security.Claims;
using System.Security.Cryptography.X509Certificates;
using System.Text;

namespace MyCash.Auth;
...
public static class Extensions
{
    ...
    public static IServiceCollection AddAuthConfig(this IServiceCollection services, IConfiguration config)
        => services.Configure<AuthOptions>(config.GetSection(SectionName));

    public static IServiceCollection AddAuth(this IServiceCollection services, IOptions<AuthOptions> projectDivisonsSettingsOptions)
    {
        var options = projectDivisonsSettingsOptions.Value;
